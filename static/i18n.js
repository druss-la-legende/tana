...
const TRANSLATIONS = {
  fr: {
    ...
    "config.sources": "Dossiers source",
    "config.sources_hint": "Dossiers scann\u00e9s pour trouver les fichiers \u00e0 organiser.",
    "config.source_placeholder": "/chemin/vers/dossier",
    "config.error.duplicate_source": "Ce dossier est d\u00e9j\u00e0 dans la liste",
    "config.error.sources_required": "Au moins un dossier source est requis",
    "files.source_label": "Source : {name}",
    ...
    "config.thumbnails_enabled": "Miniatures",
    "config.thumbnails_enabled_hint": "Afficher les couvertures dans la liste des fichiers",
    ...
    "config.error.source_required": "Au moins un dossier source est requis",
    ...
    // Convert
    "convert.title": "Convertir CBR/PDF \u2192 CBZ",
    ...
    "convert.delete_original": "Supprimer les originaux apr\u00e8s conversion",
    ...
    "convert.empty": "Entrez un chemin et scannez pour trouver les fichiers CBR/PDF",
    "convert.no_cbr": "Aucun fichier CBR/PDF trouv\u00e9",
    "convert.dpi_label": "R\u00e9solution (DPI)",
    "convert.quality_label": "Qualit\u00e9 JPEG",
    ...
    "trash.info": "{count} fichier(s) \u2014 {size}",
    "trash.col.file": "Fichier",
    "trash.col.size": "Taille",
    "trash.col.deleted_at": "Supprim\u00e9 le",
    "trash.col.actions": "Actions",
    "trash.btn.purge": "Vider la corbeille",
    "trash.btn.refresh": "Rafra\u00eechir",
    "trash.btn.restore": "Restaurer",
    "trash.btn.restore_selected": "Restaurer la s\u00e9lection",
    "trash.btn.restore_n": "Restaurer ({count})",
    "trash.btn.delete_selected": "Supprimer d\u00e9finitivement",
    "trash.btn.delete_n": "Supprimer ({count})",
    "trash.restored": "{name} restaur\u00e9",
    "trash.restored_n": "{count} fichier(s) restaur\u00e9(s)",
    "trash.deleted_permanent": "{name} supprim\u00e9 d\u00e9finitivement",
    "trash.purged_n": "{count} fichier(s) supprim\u00e9(s)",
    "trash.purged_all": "Corbeille vid\u00e9e ({count} fichier(s))",
    "trash.confirm_delete_one": "Supprimer d\u00e9finitivement {name} ?",
    "trash.confirm_delete_n": "Supprimer d\u00e9finitivement {count} fichier(s) ?",
    "trash.confirm_purge_all": "Vider toute la corbeille ? Cette action est irr\u00e9versible.",
    "trash.error.load": "Erreur lors du chargement de la corbeille",
    "trash.error.restore": "Erreur lors de la restauration",
    "trash.error.delete": "Erreur lors de la suppression",
    "history.filter.purge_trash": "Purge corbeille",
    "history.action.purge_trash": "Purge corbeille",
  },
  en: {
    // Header
    ...
    "config.sources": "Source directories",
    "config.sources_hint": "Directories scanned to find files to organize.",
    "config.source_placeholder": "/path/to/directory",
    "config.error.duplicate_source": "This directory is already in the list",
    "config.error.sources_required": "At least one source directory is required",
    "files.source_label": "Source: {name}",
    ...
    "config.thumbnails_enabled": "Thumbnails",
    "config.thumbnails_enabled_hint": "Show cover thumbnails in the file list",
    ...
    "config.error.source_required": "At least one source directory is required",
    ...
    // Convert
    "convert.title": "Convert CBR/PDF \u2192 CBZ",
    ...
    "convert.delete_original": "Delete originals after conversion",
    ...
    "convert.empty": "Enter a path and scan to find CBR/PDF files",
    "convert.no_cbr": "No CBR/PDF files found",
    "convert.dpi_label": "Resolution (DPI)",
    "convert.quality_label": "JPEG quality",
    ...
    "trash.info": "{count} file(s) \u2014 {size}",
    "trash.col.file": "File",
    "trash.col.size": "Size",
    "trash.col.deleted_at": "Deleted on",
    "trash.col.actions": "Actions",
    "trash.btn.purge": "Empty trash",
    "trash.btn.refresh": "Refresh",
    "trash.btn.restore": "Restore",
    "trash.btn.restore_selected": "Restore selection",
    "trash.btn.restore_n": "Restore ({count})",
    "trash.btn.delete_selected": "Delete permanently",
    "trash.btn.delete_n": "Delete ({count})",
    "trash.restored": "{name} restored",
    "trash.restored_n": "{count} file(s) restored",
    "trash.deleted_permanent": "{name} permanently deleted",
    "trash.purged_n": "{count} file(s) deleted",
    "trash.purged_all": "Trash emptied ({count} file(s))",
    "trash.confirm_delete_one": "Permanently delete {name}?",
    "trash.confirm_delete_n": "Permanently delete {count} file(s)?",
    "trash.confirm_purge_all": "Empty all trash? This action cannot be undone.",
    "trash.error.load": "Error loading trash",
    "trash.error.restore": "Error during restoration",
    "trash.error.delete": "Error during deletion",
    "history.filter.purge_trash": "Purge trash",
    "history.action.purge_trash": "Purge trash",
  },
};
